...
MATRIX_CSV = os.path.join(os.path.dirname(__file__), "..", "data", "returns_matrix.csv")
...
def load_matrix(path: str = MATRIX_CSV) -> pd.DataFrame:
...
def run_all(matrix_csv: str = MATRIX_CSV, n_trials: Optional[int] = None) -> Dict:
